...
环境要求：如果从源码安装，需要 macOS + Xcode 16，iOS 17+，CocoaPods，真机 + Apple ID
...
- 从 [GitHub Releases](https://github.com/kellyvv/PhoneClaw/releases) 下载最新的空壳 `IPA`
- 使用你自己的签名方式自行安装
- 首次打开后进入「模型设置」，按需下载 E2B 或 E4B
